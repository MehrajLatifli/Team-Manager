...
{
    public partial class ViewTeam334 : Form
    {
        public ViewTeam334()
        {
            InitializeComponent();
        ...
        public ViewTeam334(string s0, string s1, string s2, string s3, string s4, string s5, string s6, string s7, string s8, string s9, string s10, string sn0, string sn1, string sn2, string sn3, string sn4, string sn5, string sn6, string sn7, string sn8, string sn9, string sn10, string flag)
        {
            InitializeComponent();
            label1.Text = s10;
            label2.Text = s1;
